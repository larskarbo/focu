...
const Post = ({ data, location }) => {
  ...
  return (
    <div className=" pb-24 flex flex-row justify-center bg-gradient-to-tr from-gray-100 to-gray-50">
      ...
      <Helmet>
        <meta property="og:url" content={"https://focusmonkey.io" + location.pathName} />
        <link rel="canonical" href={"https://focusmonkey.io" + location.pathName} />
        ...
        <meta property="og:site_name" content="FocusMonkey Blog" />
        ...
        <div className=" my-12">
          <div className="flex items-center">
            ...
            <div className="text-2xl  ">
              FocusMonkey <span className="font-thin">Blog</span>
            </div>
          </div>
        </div>
